...
function setSelect(obj){
	...
	$.ajax({
			type : "POST",
			url : "<%=basePath%>message/message_ajaxlist?page_start=<%=page_start %>&page_size=<%=page_size %>",
			dateType: "json", 
...
function refresh(){
	...
	window.open("<%=basePath + "private"%>/message_list.jsp?page_start=" + page_start + "&&page_size=" + page_size ,"_self");
	//alert("refresh");
	//alert(page_start + "\n" + page_size);
}
//-->
