...
<font color="red"><b>试题添加页面</b></font>
...
--%>
  ...
  <form action="<%=basePath %>question/choice_add" method="post" id="form1">
  <input type="hidden" value="<%=id %>" name="mgr_id" />
  <input type="hidden" value="C" name="category" id="category"/>
  <input type="hidden" value="0" name="specify_id" id="specify_id"/>
  
  <table>
  	<tr><td>知识点：</td><td><span id="specify_name"></span><span id="s_id"></span></td></tr>
  	<tr><td>试题类型：</td><td><span>选择题</span></td></tr>
  	<tr><td>标题：</td><td><textarea name="title" id="title"></textarea></td></tr>
  	<tr><td>选项：</td><td><textarea name="option" id="option"></textarea></td></tr>
  	<tr>
  		<td>答案：</td>
  		<td>
  			A<input type="checkbox" value="A" name="answer"/>
  			B<input type="checkbox" value="B" name="answer"/>
  			C<input type="checkbox" value="C" name="answer"/>
  			D<input type="checkbox" value="D" name="answer"/>
  			E<input type="checkbox" value="E" name="answer"/>
  			F<input type="checkbox" value="F" name="answer"/>
  			G<input type="checkbox" value="G" name="answer"/>
  		</td>
  	</tr>
  	<tr>
  		<td>难度：</td>
  	...
  	<tr><td>分析或备注：</td><td><textarea name="analys" id="analys"></textarea></td></tr>
  </table>
