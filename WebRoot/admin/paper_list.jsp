...
$(document).ready(function(){
	var page_start = <s:property value="paperDto.page_start" />;
	var page_size = <s:property value="paperDto.page_size" />;
	var total = <s:property value="paperDto.total" />;
...
function refresh(){
	...
	window.open("<%=basePath%>paper/paper_list?page_start=" + page_start + "&&page_size=" + page_size ,"_self");
	//alert("refresh");
	//alert(page_start + "\n" + page_size);
}
function del(obj){
	if(confirm("您确定要删除此试卷吗？"))
		$.ajax({
			type : "POST",
			url : "<%=basePath %>paper/paper_delete",
			data : "id="+ obj,
...
//-->
  ...
  <tr id="title">
   ...
   <s:iterator value="papers" var="paper" status="status">
  	<tr  class="list">
  		<td><span><a href='paper_show?id=<s:property value="#paper.getId()"/>'><s:property value="#paper.getName()"/></a></span></td>
  		<td><s:property value="#paper.getId()"/></td>
  		<td><s:property value="#paper.getDegree()"/></td>
  		<td><s:property value="#paper.getQus_mount()"/></td>
  		<td><s:property value="#paper.getMgr_id()"/></td>
  		<td><span onclick='del(<s:property value="#paper.getId()"/>)'>删除</span></td>
  		<td><span><a href='paper_show?id=<s:property value="#paper.getId()"/>'>修改</a></span></td>
  		<td><span><a href='paper_qus?id=<s:property value="#paper.getId()"/>'>填充试卷</a></span></td>
  	</tr>
  	</s:iterator>
  ...
  <table>
  	<tr>
  		<td>一共<s:property value="paperDto.total" />条记录</td>
  		<td>当前第
